...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Edit missing-item-status #{{ $missing-item-status->id }}</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/missing-item-status/' . $missing-item-status->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
